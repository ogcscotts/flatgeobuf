...
FlatGeobuf does represent Simple Features per OpenGIS Implementation Specification for Geographic information - Simple feature access - Part 1: Common architecture 1.2.1. 
